...
public final class DependenciesNode extends AbstractNode {
    ...
    private static final String ARCHIVE_ICON = "org/nbgradle/netbeans/java/jar.gif";//NOI18N
    private static final Image ICON_BADGE = ImageUtilities.loadImage(
            "org/nbgradle/netbeans/java/libraries-badge.png");    //NOI18N
     ...
     * @return node holding compile dependencies.
     */
            ...
            protected void addLibraries(List<Key> result) {
                ...
                if (cpProvider != null) {
                    ...
                    for (FileObject cpRoot : compileCP.getRoots()) {
                        ...
                        result.add(new Key(createLibrarySourceGroup(archiveFile.getNameExt(), cpRoot)));
                    }
                }
            }
        };
        ...
        DependenciesChildren children = new DependenciesChildren(project) {
            ...
            protected void addLibraries(List<Key> result) {
                ...
                if (cpProvider != null) {
                    ...
                    SourceGroup[] testSourceGroups = srcs.getSourceGroups(NbGradleConstants.SOURCES_TYPE_TEST_JAVA);
