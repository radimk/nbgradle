...
public class AuxiliaryPropertiesImpl implements AuxiliaryProperties {
   ...
   */
  public static final String PROJECT_PROPERTIES_PATH = "nbgradle/project.properties"; // NOI18N
  /**
   * Relative path from project directory to the customary private properties file.
   */
  public static final String PRIVATE_PROPERTIES_PATH = "nbgradle/private.properties"; // NOI18N
  ...
  public AuxiliaryPropertiesImpl(Project aProject) {
